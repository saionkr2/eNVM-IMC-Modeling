...
np.save('SNR_dB_FeFET_vs_N_E1b.npy', SNR_dB)
np.save('AGeq_FeFET_vs_N.npy', Avg_Geq)
#%% 
...
fig1 = plt.figure(figsize=(11,8))
ax1 = fig1.add_subplot(1,1,1)
ax1.plot(N_all, SNR_max,c="r", markersize=10, marker='o', linewidth=lin_w)
ax1.grid(1,'major', linewidth=0.5, color='black')
ax1.grid(1,'minor', linewidth=0.5, ls='--')
plt.xscale("log")
ax1.set_axisbelow(True)
plt.box(1)
#plt.savefig('FeFET_SNR_max_vs_N.pdf', bbox_inches='tight',dpi=200)
