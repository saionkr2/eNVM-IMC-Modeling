...
np.save('SNR_dB_MRAM_vs_N_E1b.npy',SNR_dB)
np.save('AGeq_MRAM_vs_N.npy', Avg_Geq)
#%% 
...
ax1.set_axisbelow(True)
plt.box(1)
#plt.savefig('MRAM_SNR_max_vs_N.pdf', bbox_inches='tight',dpi=200)
