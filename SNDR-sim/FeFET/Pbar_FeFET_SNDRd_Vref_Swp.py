...
#np.save('SNDRd_dB_FeFET_vs_Vbl.npy',SNDRd)
#%% 
...
ax1.plot(V_bl_all, SNDRd_dB[0,:],c="r", markersize=10, marker='o', linestyle='-', linewidth=lin_w,label='Behavioral')
...
#plt.savefig('FeFET_SNDRd_vs_Vbl_plot.pdf', bbox_inches='tight', dpi =200)   
