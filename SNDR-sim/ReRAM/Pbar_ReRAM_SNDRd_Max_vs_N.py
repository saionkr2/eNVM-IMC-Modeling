...
np.save('SNDRd_dB_ReRAM_vs_N.npy', SNDRd_dB)
...
ax1.plot(N_all*0.5, SNDRd_max,c="r", markersize=10, marker='o', linewidth=lin_w)
ax1.grid(1,'major', linewidth=0.5, color='black')
ax1.grid(1,'minor', linewidth=0.5, ls='--')
plt.xscale("log")
ax1.set_axisbelow(True)
plt.box(1)
#plt.savefig('ReRAM_SNDRd_max_vs_N.pdf', bbox_inches='tight',dpi=200)
