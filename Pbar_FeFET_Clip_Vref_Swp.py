...
#np.save('SNR_dB_FeFET_vs_Vbl.npy',SNR)
#%% 
...
ax1.plot(V_bl_all, SNR_dB[0,:],c="r", markersize=10, marker='o', linestyle='-', linewidth=lin_w,label='Behavioral')
...
plt.xlabel(r'$V_{\mathrm{ref}}$ (V)',fontsize=25,fontdict=font)

#plt.savefig('FeFET_SNR_vs_Vbl_plot.pdf', bbox_inches='tight', dpi =200)   
